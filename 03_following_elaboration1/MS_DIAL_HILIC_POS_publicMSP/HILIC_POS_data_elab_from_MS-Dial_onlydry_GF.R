...
HLPnrf <- read_tsv("C_elegans_HILIC_POS_Area_0_2023_07_26_14_21_03_mod.txt")
HLP_feat_info <- read_tsv("C_elegans_HILIC_POS_Area_featINFO_0_2023_07_26_14_21_03_mod.txt")
...
write_tsv(HLP4_shem1_dry_transf, "MSDIAL_HLP4_shem1_dry_transf.txt")
write_tsv(HLP4_shem1_dry_ANOVA, "MSDIAL_HLP4_shem1_dry_ANOVA.txt")

write_tsv(HLP4_shem2_dry_transf, "MSDIAL_HLP4_shem2_dry_transf.txt")
write_tsv(HLP4_shem2_dry_ANOVA, "MSDIAL_HLP4_shem2_dry_ANOVA.txt")
...
write_tsv(HLP_feat_info_annolevels, "HILICPOS_MSDial_feat_info_annolevels.txt")
...
write_tsv(HLP_feat_info_annolevels_QCfiltered, "HILICPOS_MSDial_feat_info_annolevels_QCfiltered.txt")
...
write_tsv(HLP_feat_info_annolevels_QCfiltered_scheme1_dry, "HILICPOS_MSDial_feat_info_annolevels_QCfiltered_scheme1_dry.txt")
...
write_tsv(HLP_feat_info_annolevels_QCfiltered_scheme2_dry, "HILICPOS_MSDial_feat_info_annolevels_QCfiltered_scheme2_dry.txt")
...
write_tsv(HLP4_shem1_dry_ANOVA_sign_annotat_withLevels, "HILICPOS_MSDial_scheme1_dry_ANOVA_sign_annotat_withLevels.txt")
...
write_tsv(HLP4_shem2_dry_ANOVA_sign_annotat_withLevels, "HILICPOS_MSDial_scheme2_dry_ANOVA_sign_annotat_withLevels.txt")

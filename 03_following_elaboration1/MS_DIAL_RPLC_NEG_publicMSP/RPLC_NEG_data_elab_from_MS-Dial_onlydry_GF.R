...
RPNnrf <- read_tsv("C_elegans_RPLC_NEG_Area_features_0_2023_04_03_14_20_34.txt")
RPN_feat_info <- read_tsv("C_elegans_RPLC_NEG_Area_featINFO_0_2023_04_03_14_20_34.txt")
...
write_tsv(RPN4_scheme1_dry_transf, "MSDIAL_RPN4_scheme1_dry_transf.txt")
write_tsv(RPN4_scheme1_dry_ANOVA, "MSDIAL_RPN4_scheme1_dry_ANOVA.txt")
write_tsv(RPN4_scheme2_dry_transf, "MSDIAL_RPN4_scheme2_dry_transf.txt")
write_tsv(RPN4_scheme2_dry_ANOVA, "MSDIAL_RPN4_scheme2_dry_ANOVA.txt")
...
write_tsv(RPN_feat_info_annolevels, "RPLCNEG_MSDial_feat_info_annolevels.txt")
...
write_tsv(RPN_feat_info_annolevels_QCfiltered, "RPLCNEG_MSDial_feat_info_annolevels_QCfiltered.txt")
...
write_tsv(RPN_feat_info_annolevels_QCfiltered_scheme1_dry, "RPLCNEG_MSDial_feat_info_annolevels_QCfiltered_scheme1_dry.txt")


RPN_feat_info_annolevels_QCfiltered_scheme2_dry <- filter(RPN_feat_info_annolevels, Alignment_ID %in% RPN_feat_dry_2U)

write_tsv(RPN_feat_info_annolevels_QCfiltered_scheme2_dry, "RPLCNEG_MSDial_feat_info_annolevels_QCfiltered_scheme2_dry.txt")
...
write_tsv(RPN4_scheme1_dry_ANOVA_sign_annotat_withLevels, "RPLCNEG_MSDial_scheme1_dry_ANOVA_sign_annotat_withLevels.txt")
...
write_tsv(RPN4_scheme2_dry_ANOVA_sign_annotat_withLevels, "RPLCNEG_MSDial_scheme2_dry_ANOVA_sign_annotat_withLevels.txt")
